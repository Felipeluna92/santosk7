...
function MetricCard({
  ...
  return (
    <div className="interactive-panel relative overflow-hidden px-4 py-5 sm:px-5">
      <div className="flex items-start justify-between">
        <p className="text-[10px] font-bold uppercase tracking-[0.14em] text-muted-foreground">{label}</p>
        <span className="flex h-8 w-8 items-center justify-center rounded-md bg-primary/10"><Icon className="h-4 w-4 text-primary" /></span>
      </div>
